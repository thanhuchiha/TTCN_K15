        ...
        <div class="w3ls-banner">
            ...
            <div class="container_1">
                ...
                <div class="agile-form">
                    <form action="/CustomerUpdate_Servlet" method="GET" name="myform" onsubmit="return myCheck()">
                        <ul class="field-list">
                            <li>
                                ...
                                <div class="form-input">
                                    <input type="text" name="ARCustomerID" value="${CustomerInfo.ARCustomerID}" placeholder="STT" required readonly="">
                                </div>
                            </li>
                            <li>
                                <label class="form-label">
                                ...
                                <div class="form-input">
                                    <input type="text" name="ARCustomerNo" value="${CustomerInfo.ARCustomerNo}" placeholder="Mã khách hàng" required>
                                </div>
                            </li>
                            <li>
                                <label class="form-label">
                                ...
                                <div class="form-input">
                                    <input type="text" name="ARCustomerName" value="${CustomerInfo.ARCustomerName}" placeholder="Tên khách hàng" required>
                                </div>
                            </li>
                            <li>
                                <label class="form-label">
                            ...
                            <li>
                                ...
                                <div class="form-input dob">
                                    ...
                                    <span class="form-sub-label">
                                        <input type="text" class="year" value="1455" name="year" placeholder=" Enter Year" required>
                            ...
                            <li>
                                ...
                                <div class="form-input add">
                                    <span class="form-sub-label">
                                        <input type="text" name="SoNhaTenDuong" placeholder=" " value="1455" required />
                                        <label class="form-sub-label1"> Số nhà,tên đường </label>
                                    </span>
                                    <span class="form-sub-label">
                                        <input type="text" name="PhuongXa" value="1455" placeholder=" " required>
                                        <label class="form-sub-label1">Phường,xã</label>
                                    </span>
                                    <span class="form-sub-label">
                                        <input type="text" name="QuanHuyen"value="1455" placeholder=" " required>
                                        <label class="form-sub-label1"> Quận,huyện,thị trấn,thành phố</label>
                                    </span>
                                    <span class="form-sub-label">
                                        <input type="text" name="Tinh" value="1455" placeholder=" " required>
                                        <label class="form-sub-label1"> Tỉnh,thành phố </label>
                                    </span>
                                    <span class="form-sub-label">
                                        <input type="text" name="zipcode"value="1455" placeholder=" ">
                                        <label class="form-sub-label1"> Postal / Zip Code </label>
                                    </span>
                                    <span class="form-sub-label">
                                        <input type="text" name="Country" value="1455" placeholder=" " required>
                            ...
                            <li>
                                ...
                                <div class="form-input">
                                    <input type="text" name="ARCustomerPhone" value="${CustomerInfo.ARCustomerPhone}" placeholder="0905741243">
                                </div>
                            </li>
                            <li>
                                <label class="form-label">
